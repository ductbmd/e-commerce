			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{ asset('public/images/product_1.jpg') }}" alt=""></div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{ asset('public/images/product_2.jpg') }}" alt=""></div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{ asset('public/images/product_3.jpg') }}" alt=""></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">Smart Phone</a></div>
								<div class="product_price">$670</div>
							</div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{ asset('public/images/product_4.jpg') }}" alt=""></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">Smart Phone</a></div>
								<div class="product_price">$670</div>
							</div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{ asset('public/images/product_5.jpg') }}" alt=""></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">Smart Phone</a></div>
								<div class="product_price">$670</div>
							</div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{ asset('public/images/product_6.jpg') }}" alt=""></div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{ asset('public/images/product_7.jpg') }}" alt=""></div>
							<div class="product_content">
								<div class="product_title"><a href="product.html">Smart Phone</a></div>
								<div class="product_price">$670</div>
							</div>
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="{{ asset('public/images/product_8.jpg') }}" alt=""></div>
		...
		<div class="container">
			<div class="row icon_box_row">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="{{ asset('public/images/icon_1.svg') }}" alt=""></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="{{ asset('public/images/icon_2.svg') }}" alt=""></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="{{ asset('public/images/icon_3.svg') }}" alt=""></div>
